...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: RegistrosWidget.routeName,
          path: RegistrosWidget.routePath,
          builder: (context, params) => params.isEmpty
        ...
        FFRoute(
          name: AddRegistroWidget.routeName,
          path: AddRegistroWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AddRegistro')
              : AddRegistroWidget(),
        ),
        FFRoute(
